...
impl AudioManifestStore {
    ...
    /// узнав. Подписанное слепком канал перебивает: массовое назначение —
    /// осознанное действие человека, а слепок ставился автоматически.
    /// Порядок задан `SpeakerSource::may_overwrite` (ADR-013).
