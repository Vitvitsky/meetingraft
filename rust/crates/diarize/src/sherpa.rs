...
/// порогах: число зависит от количества материала, а не только от того,
/// кто говорит. Для встречи на час это значит больше дробления, чем на
/// десяти минутах, и это открытый вопрос к задаче 3.
