...
final class PCMDownmixer {
    ...
    func convert(_ buffer: AVAudioPCMBuffer) -> [Float] {
        ...
        // ЗАВЕДОМО ПОЛОЖИТЕЛЬНЫЙ СЛУЧАЙ — эта ветка не для мерджа.
        // Возвращён регресс, который тест обязан ловить: состояние фильтра
        // выбрасывается на каждой границе чанка.
        converter.reset()
