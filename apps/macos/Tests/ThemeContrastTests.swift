...
final class ThemeContrastTests: XCTestCase {
    ...
    /// просвечивает, и число вышло бы про несуществующий цвет.
    ///
    /// **Чего этот тест не делает.** Он держит длину двух списков и
    /// краснеет, если из них что-то удалили. Заметить **новый** токен в
    /// `Theme` он не может: списки живут здесь, а не выводятся из
    /// палитры, и добавление цвета оставит обе длины прежними. Это
    /// известное ограничение, а не свойство; вывести список из `Theme`
    /// нечем, пока токены — отдельные `static let`.
